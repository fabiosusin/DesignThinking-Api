...
namespace XApi.Controllers.Intra.Employee
{
    ...
    public class EmployeeController : BaseController<EmployeeController>
    {
        ...
        public IActionResult UpsertCustomer(IntraEmployee input) => Ok(Bl.UpsertEmployee(input));
        ...
        [HttpPost, Route("list")]
        public IActionResult ListCustomer(IntraEmployeeListInput input) => Ok(Bl.List(input));
    }
}
